...
{{--                        <input type="checkbox" style="margin-left: 20px;" name="remember_token" class="custom-control-input ml-5" id="customControlInline">--}}
{{--                        <label style="color: inherit" class="custom-control-label" for="customControlInline">Remember me</label>--}}
{{--                    </div>--}}
                    <div class="fBootsnipp.comrm-group">
                        <!-- Button -->
